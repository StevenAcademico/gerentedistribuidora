...
<body class="white-bg">
                                    ...
                                    <div class="grey-bg" style="border:2px solid black;border-radius: 20px;">
                                        <table width="100%" border="0" height="170" cellpadding="6" cellspacing="0">
                                            <tbody>
                                                ...
                                                <tr>
                                                    <td align="center">
                                                        <span style="font-family:Tahoma, Geneva, sans-serif; font-size:19px;color:black" text-align="center"><strong>COMPRA</strong></span>
                                                        <br>
                                                        <span style="font-size:24px;color:black" text-align="center"><strong><?=$compraList[0]['CodCompra']?></strong></span>
                                                    </td>
                                                </tr>
                                            </tbody>
                                        </table>
    ...
    <div class="tabla_borde">
        <table width="100%" border="0" cellpadding="5" cellspacing="0">
            <tbody>
                <tr>
                    <td align="right"> <span style="font-size:15px" text-align="center"><strong>Fecha.: </strong><?=$compraList[0]['Emision']?></span></td>
                </tr>
    ...
    <div class="tabla_borde">
        <table width="100%" border="0" cellpadding="5" cellspacing="0">
            <tbody>
                <tr>
                    <td align="left"> 
                        <span style="font-size:15px" text-align="center"><strong>Proveedor: </strong><?=$compraList[0]['Proveedor']?></span>
                    </td>
                </tr>
